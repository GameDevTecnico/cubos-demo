...
CUBOS_REFLECT_IMPL(roll_racers::SpawnOrphan)
{
    return cubos::core::ecs::TypeBuilder<SpawnOrphan>("roll_racers::SpawnOrphan").wrap(&SpawnOrphan::scene);
}

void roll_racers::spawnOrphanPlugin(Cubos& cubos)
{
