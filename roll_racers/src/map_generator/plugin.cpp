...
CUBOS_REFLECT_IMPL(roll_racers::MapGenerator)
{
    return cubos::core::ecs::TypeBuilder<MapGenerator>("roll_racers::MapGenerator")
...
void roll_racers::mapGeneratorPlugin(Cubos& cubos)
{
