...
CUBOS_REFLECT_IMPL(roll_racers::MapTile)
{
    return cubos::core::ecs::TypeBuilder<MapTile>("roll_racers::MapTile")
        .withField("scene", &MapTile::scene)
        .withField("rotation", &MapTile::rotation)
        .build();
}

CUBOS_REFLECT_IMPL(roll_racers::Map)
{
    return cubos::core::ecs::TypeBuilder<Map>("roll_racers::Map")
        .withField("tiles", &Map::tiles)
        .withField("tileSize", &Map::tileSize)
        .build();
}

void roll_racers::mapPlugin(Cubos& cubos)
{
