...
CUBOS_REFLECT_IMPL(roll_racers::DayNightManager)
{
    return cubos::core::ecs::TypeBuilder<DayNightManager>("roll_racers::DayNightManager")
...
CUBOS_REFLECT_IMPL(roll_racers::CarLight)
{
    return cubos::core::ecs::TypeBuilder<CarLight>("roll_racers::CarLight").build();
}

void roll_racers::dayNightPlugin(Cubos& cubos)
{
