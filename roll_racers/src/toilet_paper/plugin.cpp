...
CUBOS_REFLECT_IMPL(roll_racers::ToiletPaper)
{
    return cubos::core::ecs::TypeBuilder<ToiletPaper>("roll_racers::ToiletPaper")
...
void roll_racers::toiletPaperPlugin(Cubos& cubos)
{
    cubos.depends(transformPlugin);
    cubos.depends(collisionsPlugin);
    cubos.depends(roll_racers::interpolationPlugin);
    cubos.depends(roll_racers::carPlugin);
    cubos.depends(roll_racers::scorePlugin);
