...
void playerPluginAirship(Cubos& cubos)
{
    ...
    cubos.depends(demo::interactablePlugin);

    cubos.component<demo::Player>();

    // Plugin para mover o jogador
    cubos.system("move player")
        .call([](Commands cmds, Query<demo::Player&, Position&, Rotation&> players, const DeltaTime& dt,
                 const Input& input) {
