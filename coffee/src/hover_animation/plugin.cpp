...
CUBOS_REFLECT_IMPL(coffee::HoverAnimation)
{
    return cubos::core::ecs::TypeBuilder<HoverAnimation>("coffee::HoverAnimation")
...
void coffee::hoverAnimationPlugin(Cubos& cubos)
{
